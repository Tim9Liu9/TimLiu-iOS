...
* [UUChatTableView](https://github.com/layerhq/Atlas-iOS) - Layer家开源了一套聊天app界面的解决方案..看起来很赞，很多蛮复杂的东西直接都帮封好了。不得不说现在做app开发真是很简单，大部分时间搭积木就可以了。[官方网站](https://atlas.layer.com/)。
